...
public partial class Card : ContentView
{
    ...
    /// <summary>
    /// Evento Doble Click sobre Titulo
    /// </summary>
    public event EventHandler<EventArgs>? TitleDoubleClicked;
    ...
    /// <summary>
    /// Dobre Click On Title
    /// </summary>
    private void OnTitle2(object sender, EventArgs e) => TitleDoubleClicked?.Invoke(this, new());


    /// <summary>
    /// Doble Click On SubTitle
    /// </summary>
    private void OnSubTitle2(object sender, EventArgs e) 
    {
        var fadeAnimation = new FadeAnimation();
        fadeAnimation.Animate(anim);
        SubTitleDoubleClicked?.Invoke(this, new()); 
    }
