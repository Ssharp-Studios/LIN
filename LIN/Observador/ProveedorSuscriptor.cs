...
namespace LIN.Observador
{
    ...
    /// </summary>
    public class ProveedorSuscriptor
    {

        /// <summary>
        /// Lista de suscripciones
        /// </summary>
        public static readonly Dictionary<int, HashSet<IProveedorable>> Data = new();
        ...
        /// </summary>
        public static void Suscribe(IProveedorable productable)
        {
            // Index
        ...
        /// </summary>
        public static void Notify(IProveedorable productable)
        {
